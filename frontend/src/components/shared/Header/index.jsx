            ...
            <div style={{ paddingLeft: '5%', paddingRight: '3%', display: 'flex', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                    <div style={{ display: 'flex', flexDirection: 'row', width: '18%', justifyContent: 'space-between' }}>
                        ...
                        <Text style={{ fontSize: 14, paddingLeft: 16, paddingRight: 16  }}>VENDORS</Text>
                        <Text style={{ fontSize: 14, paddingLeft: 16, paddingRight: 16  }}>SHOP</Text>
                        ...
                        <div onClick={() => console.log()} style={{ backgroundColor: '#DEC6AF', paddingLeft: 16, paddingRight: 16, paddingTop: 4, paddingBottom: 4, borderRadius: 30, display: 'flex', alignItems: 'center', whiteSpace: 'nowrap' }}>
                            <ButtonText style={{ color: 'white' }}>BOOK NOW</ButtonText>
                        </div>
                    </div>
                </div>
            </div>
