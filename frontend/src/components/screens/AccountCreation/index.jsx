...
const AccountCreation = ({ setShowAccountCreation }) => {
    ...
    return (
        <>
            <Header />
            <div style={{ height: '70vh', paddingLeft: 100, paddingTop: 54, paddingRight: 100 }}>
                <div style={{ display: 'flex', alignItems: 'center', marginLeft: 30, marginBottom: 40 }} onClick={() => setShowAccountCreation(false)}>
